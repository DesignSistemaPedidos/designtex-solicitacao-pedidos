    ...
    <div class="container">
        ...
        <div class="info">
            ...
            <ul class="endpoints">
                ...
                <li><code>POST /pedidos</code> - Criar pedido (futuro)</li>
            </ul>
        </div>
...
def health():
    ...
    if conn:
        try:
            ...
            # Verificar se está usando Railway
            is_railway = 'railway.net' in DATABASE_CONFIG.get('database_url', '') if 'database_url' in DATABASE_CONFIG else False
...
if __name__ == '__main__':
    ...
    if init_database():
        print("🚀 Iniciando DESIGNTEX TECIDOS - Railway PostgreSQL Web")

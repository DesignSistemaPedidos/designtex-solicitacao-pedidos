...
def submit_pedido():
    try:
        ...
        return jsonify({
            'success': True,
            'message': f'Pedido Designtex salvo! Email com PDF será enviado via EmailJS.',
...
def gerar_pdf_pedido(dados, pdf_path):
    """Gerar PDF do pedido Designtex com novas cores"""
    try:
        ...
        if dados['produtos']:
            ...
            produtos_table.setStyle(TableStyle([
                ...
                # Ajuste de largura
                ('COLWIDTHS', (0, 0), (-1, -1),
                 [1.5*inch, 1*inch, 1.3*inch, 1*inch, 1*inch, 1*inch]),
                ('WORDWRAP', (0, 0), (-1, -1), True)  # Quebra de palavras
            ]))
...
if __name__ == '__main__':
    ...
    print("🚀 Iniciando DESIGNTEX TECIDOS com novos ajustes...")
    ...
    print("🎨 Cores: Fundo cinza #80858b")
    print("📱 Mobile: Fontes otimizadas")
    print("=" * 60)
